...
bool btrfs_zone_activate(struct btrfs_block_group *block_group)
{
  ...
  struct btrfs_space_info *space_info = block_group->space_info; //btrfs_v6
	struct map_lookup *map;
	struct btrfs_device *device;
	u64 physical;
	bool ret;
  ...
  spin_lock(&space_info->lock); // btrfs_v6
...
out_unlock:
	spin_unlock(&block_group->lock);
  spin_unlock(&space_info->lock); //btrfs_v6
  
	return ret;
}

// btrfs_v6 // ref in 2ce543f478433a0eec0f72090d7e814f1d53d456
